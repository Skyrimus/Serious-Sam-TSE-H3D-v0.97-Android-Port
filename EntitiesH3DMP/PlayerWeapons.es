...
#include "EntitiesH3DMP/Common/AutoAimTarget_Texture.h"
...
uses "EntitiesH3DMP/Player";
uses "EntitiesH3DMP/PlayerWeaponsEffects";
uses "EntitiesH3DMP/Projectile";
uses "EntitiesH3DMP/Bullet";
uses "EntitiesH3DMP/BasicEffects";
uses "EntitiesH3DMP/WeaponItem";
uses "EntitiesH3DMP/AmmoItem";
uses "EntitiesH3DMP/AmmoPack";
uses "EntitiesH3DMP/ModelHolder2";
uses "EntitiesH3DMP/CannonBall";
...
//    plan.m_fRecoilSpeed += wpn_fRecoilSpeed[m_iCurrentWeapon];
  ...
  void RenderCrosshair( CProjection3D &prProjection, CDrawPort *pdp, CPlacement3D &plViewSource)
  {
    ...
    if( iCrossHair>0) {
      ...
      FLOAT fSize = 16 * ((FLOAT)pdp->GetWidth() / 640.0f) * hud_fCrosshairScale;      // draw crosshair
